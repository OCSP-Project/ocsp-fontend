...
const MOCK_EQUIPMENT: EquipmentDto[] = [
  {
    id: "1",
    name: "Máy trộn vữa",
    specifications: "Dung tích: 150 lít",
    category: "Máy trộn",
  },
  {
    id: "2",
    name: "Cần trục tháp",
    specifications: "Tải trọng: 5 tấn",
    category: "Cần trục",
  },
  {
    id: "3",
    name: "Máy đầm dùi",
    specifications: "Công suất: 1.5kW",
    category: "Máy đầm",
  },
  {
    id: "4",
    name: "Vận thăng tải",
    specifications: "Tải trọng: 1 tấn",
    category: "Vận thăng",
  },
  {
    id: "5",
    name: "Máy cắt bê tông",
    specifications: "Đường kính: 350mm",
    category: "Máy cắt",
  },
  {
    id: "6",
    name: "Máy hàn điện",
    specifications: "Công suất: 200A",
    category: "Máy hàn",
  },
  {
    id: "7",
    name: "Máy bơm bê tông",
    specifications: "Tầm cao: 20m",
    category: "Máy bơm",
  },
];
...
export function EquipmentEntry({
  ...
  const handleAddEquipment = (equipment: EquipmentDto) => {
    ...
    if (equipmentEntries.find((e) => e.equipmentId === equipment.id)) {
      notification.warning({
        ...
        description: "Thiết bị này đã được thêm!",
      });
      return;
    }
  ...
  const handleUpdateEquipment = (
    id: string,
    updates: Partial<DiaryEquipmentEntry>
  ) => {
    onEquipmentEntriesChange(
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="relative">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2.5 pl-11 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all"
            />
            <svg
        ...
        {equipmentEntries.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 text-sm">Chưa có thiết bị</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="col-span-1 lg:col-span-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleUpdateEquipment(entry.id, {
                        hoursUsed: Number(e.target.value),
                      })
                    }
                    placeholder="0"
                    className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500"
                  />
                </div>
                ...
                <div className="col-span-1 lg:col-span-2">
                  ...
                  <select
                    value={entry.unit}
                    onChange={(e) =>
                      handleUpdateEquipment(entry.id, { unit: e.target.value })
                    }
                    className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                  >
