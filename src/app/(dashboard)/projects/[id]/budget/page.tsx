...
export default function BudgetPage() {
  ...
  const handleExport = async () => {
    try {
      ...
      link.href = url;
      link.download = `WorkItems_${projectId}_${new Date().toISOString().split('T')[0]}.xlsx`;
    ...
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Dự toán & Tiến độ</h1>
            <p className="text-sm text-gray-600 mt-1">Quản lý dự toán và sơ đồ Gantt</p>
          </div>
